		...
		function close(link) {
			if (leftActive || rightActive) { // If a Slidebar is open.
				...
				setTimeout(function() { // Wait for closing animation to finish.
					$('html').removeClass('sb-actives sb-active-left sb-active-right'); // Remove active classes.
					if ($left) $left.removeClass('sb-actives');
					if ($right) $right.removeClass('sb-actives');
