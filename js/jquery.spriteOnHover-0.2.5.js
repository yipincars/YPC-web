...
$.fn.spriteOnHover = function(args){
					...
					var overrideFrameSize = args.frameSize;
					var overrideNumberOfFrames = args.numberOfFrames;
					...
					$('#tempImg'+count).load(function(){
							...
							if (sprite_orientation == 'horizontal') {
							    if (overrideFrameSize > -1) {
							        var frame_size = overrideFrameSize;
							    }
							    else {
							...
							if (overrideNumberOfFrames != -1) {
							    number_of_frames = overrideNumberOfFrames;
							}
